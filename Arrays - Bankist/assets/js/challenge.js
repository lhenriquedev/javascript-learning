...
const checkDogs = (dogsJulia, dogsKate) => {
  ...
  // dogsJulia.slice(1,3)
  juliaDogsCorrect.splice(0, 1); // removes first CAT
  juliaDogsCorrect.splice(-2); // removes two last

  const dogs = juliaDogsCorrect.concat(dogsKate);
...
/* 
1. and fLoop over the array containing dog objects, or each dog, calculate the recommended food portion and add it to the object as a new property. Do NOT create a new array, simply loop over the array. Forumla: recommendedFood = weight ** 0.75 * 28. (The result is in grams of food, and the weight needs to be in kg)
*/
